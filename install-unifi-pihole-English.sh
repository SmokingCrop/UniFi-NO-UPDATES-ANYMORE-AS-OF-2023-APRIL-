...
echo -e "${Colour}THE SCRIPT WILL NOT RECEIVE ANYMORE UPDATES. IT MAY NO LONGER WORK WITH A NEW UPDATE. PLEASE TRY TO USE THE SCRIPT IN THE LINK ABOVE.\n\n${less}"
...
echo 'deb http://legacy.raspbian.org/raspbian/ stretch main contrib non-free rpi' | sudo tee /etc/apt/sources.list.d/raspbian_stretch_for_mongodb.list
